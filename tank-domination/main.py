...
while game_running_flag:
    ...
    # Create Grass.
    pygame.draw.rect(game_display["sky"]["color"], pygame.Rect(0, game_characteristics["grass"]["position"]["y"], monitor_display[0], monitor_display[1] - game_characteristics["grass"]["position"]["y"]))
